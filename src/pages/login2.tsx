  ...
  return (
    <div className="flex w-full min-h-screen bg-linear-to-r from-cyan-500 to-blue-500 items-center poppins-light">
      <div className="flex w-full h-full items-centers justify-center items-center">
        <Image alt="Image" src="/images/night2.gif" fill unoptimized/>
        <div className="bg-purple-700/85 w-[400px] h-[350px] flex flex-col gap-[10px] p-[10px] rounded-[10px] shadow-md z-10 items-center">
          ...
          <div className="w-full h-full gap-[10px] p-[10px]">
            ...
            >
              ...
              <div className="gap-[10px]">
                <button className="w-full h-fit p-[10px] gap-[10px] border rounded-[10px] cursor-pointer hover:bg-purple-700/70 poppins-bold text-[16px] outline-0 ">
                  Login
                </button>
              </div>
              <div className="gap-[10px]">
                <button
                  className="w-full h-fit p-[10px] gap-[10px] border rounded-[10px] cursor-pointer hover:bg-purple-700/70 poppins-bold text-[16px] outline-0 "
                  onClick={changeTheme}
                >
                  Change Theme
                </button>
