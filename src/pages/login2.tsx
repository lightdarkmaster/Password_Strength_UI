        ...
        <div className="bg-purple-700/85 w-[400px] h-[350px] flex flex-col gap-[10px] p-[10px] rounded-[10px] shadow-md z-10 items-center">
          ...
          <div className="w-full h-full gap-[10px] p-[10px]">
            <form onSubmit={handleLogin} className="w-full h-full flex flex-col gap-[10px] p-[10px]">
              ...
              <div className="gap-[10px]">
                <button className="w-full h-fit p-[10px] gap-[10px] border rounded-[10px] cursor-pointer hover:bg-purple-700/70 poppins-bold text-[16px] outline-0 " onClick={changeTheme}>
                  Change Theme
                </button>
              </div>
              {loginStatus && (
